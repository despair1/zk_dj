...
class Industryactivityprobabilities(models.Model):
    ...
    probability = models.TextField(blank=True)  # This field type is a guess.
...
class Invtraits(models.Model):
    typeid = models.IntegerField(db_column='typeID', blank=True, null=True)  # Field name made lowercase.
    skillid = models.IntegerField(db_column='skillID', blank=True, null=True)  # Field name made lowercase.
    bonus = models.TextField(blank=True)  # This field type is a guess.
...
class Mapcelestialstatistics(models.Model):
    ...
    spectralclass = models.TextField(db_column='spectralClass', blank=True)  # Field name made lowercase. This field type is a guess.
...
class Mapconstellations(models.Model):
    ...
    constellationname = models.TextField(db_column='constellationName', blank=True)  # Field name made lowercase. This field type is a guess.
...
class Mapdenormalize(models.Model):
    ...
    z = models.TextField(blank=True)  # This field type is a guess.
    radius = models.TextField(blank=True)  # This field type is a guess.
    itemname = models.TextField(db_column='itemName', blank=True)  # Field name made lowercase. This field type is a guess.
...
class Maplandmarks(models.Model):
    ...
    landmarkname = models.TextField(db_column='landmarkName', blank=True)  # Field name made lowercase. This field type is a guess.
...
class Mapregions(models.Model):
    ...
    regionname = models.TextField(db_column='regionName', blank=True)  # Field name made lowercase. This field type is a guess.
    x = models.TextField(blank=True)  # This field type is a guess.
    y = models.TextField(blank=True)  # This field type is a guess.
    z = models.TextField(blank=True)  # This field type is a guess.
    xmin = models.TextField(db_column='xMin', blank=True)  # Field name made lowercase. This field type is a guess.
...
class Mapsolarsystems(models.Model):
    ...
    solarsystemname = models.TextField(db_column='solarSystemName', blank=True)  # Field name made lowercase. This field type is a guess.
    x = models.TextField(blank=True)  # This field type is a guess.
    y = models.TextField(blank=True)  # This field type is a guess.
    z = models.TextField(blank=True)  # This field type is a guess.
    xmin = models.TextField(db_column='xMin', blank=True)  # Field name made lowercase. This field type is a guess.
    ...
    securityclass = models.TextField(db_column='securityClass', blank=True)  # Field name made lowercase. This field type is a guess.
...
class Ramassemblylinetypedetailpercategory(models.Model):
    ...
    costmultiplier = models.TextField(db_column='costMultiplier', blank=True)  # Field name made lowercase. This field type is a guess.
...
class Ramassemblylinetypes(models.Model):
    ...
    basecostmultiplier = models.TextField(db_column='baseCostMultiplier', blank=True)  # Field name made lowercase. This field type is a guess.
    volume = models.TextField(blank=True)  # This field type is a guess.
    activityid = models.IntegerField(db_column='activityID', blank=True, null=True)  # Field name made lowercase.
